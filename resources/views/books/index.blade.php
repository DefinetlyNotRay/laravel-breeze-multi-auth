    ...
    <body class="bg-white">
        <nav class="flex items-center justify-between bg-white drop-shadow-md">
            ...
            <div class="flex items-center gap-16 px-6 ">
                <div class="relative">
                    <a href="/books" class="font-bold active text-gray-800 hover:text-gray-800/70">Books</a>
                </div>
                <div class="relative">
                    <a href="/" class="font-bold text-gray-800 hover:text-gray-800/70">Home</a>
                </div>
                <div class="relative">
                    <a href="/" class="font-bold text-gray-800 hover:text-gray-800/70">Loans</a>
                </div>
            </div>
                ...
                <div class="w-[95%]">
                    ...
                    <div class="grid grid-cols-7 gap-5 mt-8" id="bookContainer">
                        ...
                        <div class="flex flex-col w-[200px] justify-center book" data-genre="{{$book->category->nama_category}}" data-author="{{$book->author}}">
                            <img src="{{$book->cover_img}}" class="w-[200px] h-[300px] object-cover" alt="">
                            <div>
